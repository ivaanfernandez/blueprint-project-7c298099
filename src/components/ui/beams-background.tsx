...
export function BeamsBackground({ className }: { className?: string }) {
  ...
  useEffect(() => {
    ...
    function drawBeam(ctx: CanvasRenderingContext2D, beam: Beam) {
      ...
      gradient.addColorStop(0.1, `hsla(${beam.hue}, 85%, 55%, 
                            ${pulsingOpacity * 0.5})`);
      gradient.addColorStop(0.4, `hsla(${beam.hue}, 85%, 55%, 
                            ${pulsingOpacity})`);
      gradient.addColorStop(0.6, `hsla(${beam.hue}, 85%, 55%, 
                            ${pulsingOpacity})`);
      gradient.addColorStop(0.9, `hsla(${beam.hue}, 85%, 55%, 
                            ${pulsingOpacity * 0.5})`);
